...
public class AutomobileInsurancePage extends BasePage {
	...
	private By menuAutomobile = By.xpath("//*[@name='Navigation Automobile']");
	private By selectMake = By.xpath("//*[@id='make']/option[3]");
	...
	private By selectMeritRating = By.xpath("//*[@id='meritrating']/option[12]");
	...
	private By selectCourtesyCar = By.xpath("//*[@id='courtesycar']/option[3]");
	...
	public void acessasite() {
		interactions.url("https://sampleapp.tricentis.com/101/index.php");
		interactions.waitTime(3000);
	}

	public void clicaMenuAutomobile() {
		interactions.isElementDisplayed(menuAutomobile, "menuAutomobile");
		interactions.click(menuAutomobile, "menuAutomobile");
		interactions.waitTime(3000);
	}

	public void preencheAbaVehicleData(String enginePerformance, String dataManufacture, String listPrice,
	...
	public void preencheAbaProductData(String startDate) {
		...
		interactions.click(selectMeritRating, "selectMeritRating");
		...
		interactions.click(selectCourtesyCar, "selectCourtesyCar");
