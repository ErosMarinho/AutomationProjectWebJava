...
public class TruckInsurancePage extends BasePage {

	/**
	 * MAPEAMENTO DOS COMPONENTES ELEMENTOS
	 */

	private By menuTruck = By.xpath("//*[@name='Navigation Truck']");
	private By selectMake = By.xpath("//*[@id='make']/option[7]");
	...
	private By selectNumberSeats = By.xpath("//*[@id='numberofseats']/option[10]");
	private By selectFuelType = By.xpath("//*[@id='fuel']/option[3]");	
	...
	private By selectOccupation = By.xpath("//*[@id='occupation']/option[3]");
	private By radiobuttonHobbies = By.xpath("//*[text()=' Cliff Diving']");
	...
	private By selectInsuranceSum = By.xpath("//*[@id='insurancesum']/option[8]");
	...
	private By radiobuttonUltimate = By.xpath("//th[2]/label[3]/span");
	...
	public void clicaMenuTruck() {
		interactions.isElementDisplayed(menuTruck, "menuTruck");
		interactions.click(menuTruck, "menuTruck");
		interactions.waitTime(3000);
	}

	public void preencheAbaVehicleData(String enginePerformance, String dataManufacture, String payload, String totalWeight, String listPrice,
