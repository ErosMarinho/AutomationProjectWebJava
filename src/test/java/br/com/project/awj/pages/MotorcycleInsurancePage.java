...
public class MotorcycleInsurancePage extends BasePage {
	...
	private By menuMotorcycle = By.xpath("//*[@name='Navigation Motorcycle']");
	private By selectMake = By.xpath("//*[@id='make']/option[4]");
	private By selectModel = By.xpath("//*[@id='model']/option[5]");	
	private By inputCylinderCapacity = By.xpath("//*[@id='cylindercapacity']");
	...
	private By selectNumberSeats = By.xpath("//*[@id='numberofseatsmotorcycle']/option[4]");	
	...
	private By radiobuttonGender = By.xpath("//*[text()='Female']");
	...
	private By selectOccupation = By.xpath("//*[@id='occupation']/option[4]");
	private By radiobuttonHobbies = By.xpath("//*[text()=' Skydiving']");
	...
	private By selectInsuranceSum = By.xpath("//*[@id='insurancesum']/option[6]");
	...
	private By radiobuttonUltimate = By.xpath("//th[2]/label[4]/span");
	...
	public void clicaMenuMotorcycle() {
		interactions.isElementDisplayed(menuMotorcycle, "menuMotorcycle");
		interactions.click(menuMotorcycle, "menuMotorcycle");
		interactions.waitTime(3000);
	}

	public void preencheAbaVehicleData(String cylinderCapacity, String enginePerformance, String dataManufacture, String listPrice,
			 String annualMileage) {
		interactions.click(selectMake, "selectMake");
		interactions.click(selectModel, "selectModel");
		interactions.write(inputCylinderCapacity , cylinderCapacity, "inputCylinderCapacity");
	...
	public void preencheAbaSelectPriceOption() {
		interactions.click(radiobuttonUltimate, "radiobuttonUltimate");
