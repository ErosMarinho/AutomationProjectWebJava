package br.com.project.awj.core;
...
import br.com.project.awj.core.interacao.Interactions;
...
public abstract class BasePage {
	...
	private void waitAndScroll(By button, String buttonName) {
		...
		interactions.scrollToElement(button, String.format("Scroll até o botão %s", buttonName));
	}
	...
	public String mensagemDeEnvioDeToken() {
		...
		int contador = 0;
		interactions.waitElement(mensagem, "Mensagem");
